...
class TestChargingStation:
    ...
    def setup_adapter_producer(self):
        ip = "localhost"
        port = 9093
        topic = SensorTypes.CHARGING_STATION
    ...
    def setup_simulator(self):
        ...
        return ChargingStationSimulator(sensor_name, random_obj, datetime_obj, coordinates)
    ...
    def teardown_after_test(self, setup_client):
        query = "DELETE FROM innovacity.charging_station WHERE name = 'Test';"
    ...
    def test_persistence(self, setup_client, setup_adapter_producer, setup_simulator):
        ...
        while True:
            query = "SELECT name FROM innovacity.charging_station WHERE name = 'Test';"
