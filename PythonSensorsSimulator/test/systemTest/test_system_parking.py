...
class TestRain:
    ...
    def setup_simulator(self):
        ...
        return ParkingSensorSimulator(sensor_name, random_obj, datetime_obj, coordinates)
    ...
    def teardown_after_test(self, setup_client):
        query = "DELETE FROM innovacity.parking WHERE name = 'Test';"
    ...
    def test_persistence(self, setup_client, setup_adapter_producer, setup_simulator):
        ...
        while True:
            query = "SELECT name FROM innovacity.parking WHERE name = 'Test';"
