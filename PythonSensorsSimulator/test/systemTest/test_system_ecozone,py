...
class TestEcozone:
    ...
    def setup_simulator(self):
        ...
        return EcoZoneSensorSensorSimulator(sensor_name, random_obj, datetime_obj, coordinates)
    ...
    def teardown_after_test(self, setup_client):
        query = "DELETE FROM innovacity.eco_zone WHERE name = 'Test';"
    ...
    def test_persistence(self, setup_client, setup_adapter_producer, setup_simulator):
        ...
        while True:
            query = "SELECT name FROM innovacity.eco_zone WHERE name = 'Test';"
